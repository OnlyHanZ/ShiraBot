...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Kyouka Hashiba Owner;Sakura;;Md\nFN:Ray\nNICKNAME:👑 Owner Sakura Bot\nORG:Nacht\nTITLE:hashiba\nitem1.TEL;waid=62895627514070:+62 895-6275-14070\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://nacht-website.vercel.app/\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:gaadaemailpribadi@gmail.com\nitem3.X-ABLabel:💌 Mail Owner SakuraBot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 16 Tahun\nEND:VCARD`
...
if (command == 'pengembang') {
  let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;${author};;;\nFN:${author}\nORG:${author}\nTITLE:\nitem1.TEL;waid=62895627514070:+62 895-6275-14070\nitem1.X-ABLabel:${author}\nX-WA-BIZ-DESCRIPTION:${htjava} Nih pengembang ku kack yg mengaktifkan bot ini.\nX-WA-BIZ-NAME:${author}\nEND:VCARD`
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: fgif })
}
if (command == 'creator') {
  try {
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `wudysoft@gmail.com`, `🇮🇩 Indonesia`, `🚀 Nacht`, `bimlek`],
...
handler.command = /^(owner2|pengembang|creator2)$/i
